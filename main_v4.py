...
def main():
    ...
    # group=1 তে রাখা হয়েছে যাতে MessageHandler আগে run করে,
    # TypeHandler duplicate handle না করে সেটা handle_all_messages নিজেই সামলাবে।
