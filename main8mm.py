...
async def handle_all_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. Entity mention (সবচেয়ে reliable)
    ...
    if not should_reply and msg.reply_to_message:
        ...
        if rt.from_user and (rt.from_user.username or "").lower() == bot_username:
            should_reply = True
...
def main():
    ...
    # Universal handler — TEXT + non-command, সব chat type
    app.add_handler(
        MessageHandler(
