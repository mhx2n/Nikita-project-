...
async def handle_all_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    bot_un    = _raw_un.lstrip("@").lower()   # "@UrNikitaBot" → "urnikitabot"
    ...
    if not should and msg.reply_to_message:
        ...
        elif rt.sender_chat and (
            bot_un and (rt.sender_chat.username or "").lower() == bot_un
        ):
